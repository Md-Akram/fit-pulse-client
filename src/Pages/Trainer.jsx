        ...
        <section>
            <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
                ...
                <ul className="grid gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-4">
                    {
                        trainers.map((trainer, index) => <blockquote key={index} className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-lg font-medium text-gray-900">{trainer.trainerName}</p>
                                </div>
                            </div>

                            <p className="mt-4 text-gray-700">
                                Years of exprience : {trainer.yearsOfExperience}
                            </p>
                            <p className="mt-4 text-gray-700">
                                Available time slot : {trainer.availableTimeSlots.length}
                            </p>
